      ...
      <div className="container mx-auto p-4">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {proyectos.map((project) => (
            <div
              key={project.id}
              className="flex flex-col items-center rounded-md shadow-md p-2 transition-all duration-300 ease-in-out border border-solid border-azul-custom hover:border-violeta-marca hover:bg-violeta-marca/5 hover:scale-105 mb-6 cursor-pointer"
            ...
            >
              ...
              />
              <h2 className="text-md font-bold my-2">{project.title}</h2>
