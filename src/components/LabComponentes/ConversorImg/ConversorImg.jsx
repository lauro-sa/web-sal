...
import imgAgregarConversor from "../../../assets/img/laboratorio/img-agregar-conversor.png";
import imgConversor from "../../../assets/img/laboratorio/img-conversor.png";
      ...
      <div className="flex justify-between mt-4">
        <div className="flex flex-col items-start bg-cover">
          ...
          >
            <input {...getInputProps()} />
            <img
              src={imagen || imgAgregarConversor}
              alt="Original"
        ...
        <div className="flex flex-col items-start bg-cover">
          <div className="w-40 h-40 p-4">
            <img
              src={imagenDescargable || imgConversor}
              alt="Procesada"
              className="w-full h-full object-cover"
            />
          </div>
